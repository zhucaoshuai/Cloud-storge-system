...
{
    return ProcessInfo::detail::g_startTime;
}

int ProcessInfo::clockTicksPerSecond()
{
    return ProcessInfo::detail::g_clockTicks;
}

int ProcessInfo::pageSize()
{
    return ProcessInfo::detail::g_pageSize;
}
...
{
    string result;
    FileUtil::readFile("/proc/self/status", &result);
    return result;
}
...
{
    string result;
    FileUtil::readFile("/proc/self/stat", &result);
    return result;
}
